...
# 华创金工实习 ^4f905a
1. Used multiple different factors to construct the portfolio. Like valuation multiples ([[PE Ratio|PE ratio]]), volatility factors (historical beta), profitability metrics ([[ROE]]) and Momentum metrics ([[Relative Strength Index]]);
